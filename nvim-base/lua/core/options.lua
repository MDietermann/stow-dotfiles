vim.wo.number = true -- Linenumbers (default: false)
vim.o.relativenumber = true -- Set relative numbered lines (default: false)
vim.o.clipboard = "unnamedplus" -- Sync clipboard between OS and Nvim (default: '')
vim.o.wrap = false -- displays lines as one long line (default: true)
...
vim.o.shiftwidth = 4 -- Number of spaces per tab (default: 8)
